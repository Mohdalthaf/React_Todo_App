...
function App() {
  ...
  const handleUpdatedDescrption=(value)=>{
    setCurrentEditedItem((prev)=>{
      ...
      <div className="todo-wrapper">
        <div className="todo-input">
          ...
          <div className="todo-input-item">
            ...
            <input type="text" value={newDescription} onChange={(e)=>setNewDescription(e.target.value)} placeholder="What's the task decription?"/>
          </div>
          <div className="todo-input-item">
          ...
          {isCompleteScreen===false && allTodos.map((item,index)=>{
            if(currentEdit===index){
              return(
                ...
                <textarea placeholder='Updated Description' rows={4} onChange={(e)=>handleUpdatedDescrption(e.target.value)} value={currentEditedItem.description}/>
